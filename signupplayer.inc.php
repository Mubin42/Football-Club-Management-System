<?php
  ...
  $sql = "Insert into player(player_id,player_name,player_position,player_height,
  player_weight,player_transferfee,player_age,player_nationality,player_appearances,
  player_goals,player_assists,player_keypass,player_passacc,player_crossacc,player_shotacc,
  player_tackleratio,player_yellowcard,player_redcard,player_cleansheet,player_wages,
  player_contract,player_teamrole,player_value,player_rating) values ('$player_id','$player_name',
  '$player_position','$player_height','$player_weight','$player_transferfee','$player_age','$player_nationality'
  ,'$player_appearances','$player_goals','$player_assists','$player_keypass','$player_passacc','$player_crossacc',
  '$player_shotacc','$player_tackleratio','$player_yellowcard','$player_redcard','$player_cleansheet','$player_wages',
  '$player_contract','$player_teamrole','$player_value','$player_rating');";
